...
A simple Linux kernel module that iterates through all active processes in the system and reports each process's memory accounting information. The information is exported through a /proc file. 
